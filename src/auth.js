...
// Derive region from pool id (e.g., us-east-1_XXXX -> us-east-1)
const poolId = process.env.AWS_COGNITO_POOL_ID;
if (!poolId) throw new Error('Missing AWS_COGNITO_POOL_ID in .env');
const region = poolId.split('_')[0];

// OIDC issuer for your pool (NOT the hosted UI domain)
